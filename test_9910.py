...
Uso local (sin Docker):
  ...
  # terminal 1: mongodb
  # terminal 2: uvicorn backend.main:app --port 9071
  # terminal 3: BACKEND_URL=http://127.0.0.1:9071 python test_9910.py
"""
...
os.environ.setdefault("BACKEND_URL", os.getenv("BACKEND_URL", "http://127.0.0.1:9071"))

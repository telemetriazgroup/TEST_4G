...
os.environ.setdefault("TCP_PORT", "9914")
os.environ.setdefault("HTTP_PORT", "8085")
os.environ.setdefault("BACKEND_URL", os.getenv("BACKEND_URL", "http://127.0.0.1:9085"))
